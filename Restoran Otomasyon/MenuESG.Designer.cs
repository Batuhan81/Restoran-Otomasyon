namespace Restoran_Otomasyon.Paneller
{
	partial class MenuESG
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridSecilenUrunler = new System.Windows.Forms.DataGridView();
			...
			this.panelİndirim.Location = new System.Drawing.Point(1026, 156);
			this.panelİndirim.Name = "panelİndirim";
			this.panelİndirim.Size = new System.Drawing.Size(471, 212);
			this.panelİndirim.TabIndex = 77;
			...
			this.txtindirimli.Leave += new System.EventHandler(this.txtindirimli_Leave);
			// 
			// button6
			// 
			...
			// btnresim
			// 
			this.btnresim.BackColor = System.Drawing.Color.SkyBlue;
			...
			this.gridSecilenUrunler.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
			...
			this.gridSecilenUrunler.DefaultCellStyle = dataGridViewCellStyle2;
			...
			this.gridSecilenUrunler.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
			...
			this.gridSecilenUrunler.Size = new System.Drawing.Size(485, 379);
			this.gridSecilenUrunler.TabIndex = 57;
			this.gridSecilenUrunler.CellClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.gridSecilenUrunler_CellClick);
			this.gridSecilenUrunler.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.gridSecilenUrunler_CellContentClick);
			// 
			// label12
			// 
			...
			this.label12.Location = new System.Drawing.Point(419, 7);
			this.label12.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label12.Name = "label12";
			this.label12.Size = new System.Drawing.Size(113, 16);
			this.label12.TabIndex = 67;
			this.label12.Text = "Seçilen Ürünler";
			// 
			// label11
			// 
			...
			this.checkedListMalzeme.Location = new System.Drawing.Point(12, 27);
			...
			this.gridMenu.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.gridMenu.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.gridMenu.RowHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			this.pictureBox1.Location = new System.Drawing.Point(1160, 416);
			...
			this.hiddenMenuId.TabIndex = 71;
			this.hiddenMenuId.Visible = false;
			// 
			// hiddenUrunId
			// 
			...
			this.groupMenu.Controls.Add(this.btnresim);
			this.groupMenu.Controls.Add(this.button4);
			this.groupMenu.Controls.Add(this.txtdetay);
			...
			this.groupMenu.Controls.Add(this.button2);
			this.groupMenu.Controls.Add(this.button1);
			this.groupMenu.Controls.Add(this.txtad);
			this.groupMenu.Controls.Add(this.label5);
			this.groupMenu.Controls.Add(this.label1);
			this.groupMenu.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(162)));
			this.groupMenu.Location = new System.Drawing.Point(9, 4);
			...
			this.Load += new System.EventHandler(this.MenuESG_Load);
			this.panelİndirim.ResumeLayout(false);
			this.panelİndirim.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.gridSecilenUrunler)).EndInit();
		...
		private System.Windows.Forms.DataGridView gridSecilenUrunler;
		...
		public System.Windows.Forms.TextBox hiddenMenuId;
		private System.Windows.Forms.TextBox hiddenUrunId;
